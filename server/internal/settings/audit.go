...
func instancePatchKeys(patch Patch) []string {
	...
	for name, set := range map[string]bool{
		...
		"hardwareAcceleration":         patch.HardwareAcceleration.Set,
		"preferredTranscodeVideoCodec": patch.PreferredTranscodeVideoCodec.Set,
		"transcodeQualityPreset":       patch.TranscodeQualityPreset.Set,
		"transcodeConcurrency":         patch.TranscodeConcurrency.Set,
		"transcodeMaxBitrateKbps":      patch.TranscodeMaxBitrateKbps.Set,
