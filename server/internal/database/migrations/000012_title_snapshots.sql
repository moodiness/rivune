...
ALTER TABLE titles
    ...
    ADD COLUMN IF NOT EXISTS release_info text,
    ADD COLUMN IF NOT EXISTS resource_id text,
    ADD COLUMN IF NOT EXISTS resource_provider text,
    DROP CONSTRAINT IF EXISTS titles_display_title_check,
    DROP CONSTRAINT IF EXISTS titles_poster_url_check,
    DROP CONSTRAINT IF EXISTS titles_background_url_check,
    DROP CONSTRAINT IF EXISTS titles_release_info_check,
    DROP CONSTRAINT IF EXISTS titles_resource_id_check,
    DROP CONSTRAINT IF EXISTS titles_resource_provider_check,
