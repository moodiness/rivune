...
CREATE INDEX profile_library_profile_added_at_idx
...
CREATE INDEX profile_progress_continue_idx
    ON profile_progress (profile_id, completed, last_watched_at DESC, title_id);

CREATE FUNCTION validate_profile_media_state_title() RETURNS trigger
LANGUAGE plpgsql
AS $function$
DECLARE
