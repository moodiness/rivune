...
CREATE TABLE IF NOT EXISTS addon_profile_access (
...
CREATE INDEX IF NOT EXISTS addon_profile_access_profile_order_idx
    ON addon_profile_access (profile_id, position, addon_id);

CREATE TABLE IF NOT EXISTS collection_profile_access (
...
CREATE INDEX IF NOT EXISTS collection_profile_access_profile_order_idx
