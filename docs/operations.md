...
```sh
COMPOSE_FILE=compose.yaml ./scripts/postgres-backup.sh backups/rivune-before-1.11.4.dump
./scripts/postgres-verify-backup.sh --expect-backup-id '<recorded ID>' backups/rivune-before-1.11.4.dump
# edit RIVUNE_VERSION=1.11.4 in .env
