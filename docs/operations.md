...
```sh
COMPOSE_FILE=compose.yaml ./scripts/postgres-backup.sh backups/rivune-before-1.6.0.dump
./scripts/postgres-verify-backup.sh --expect-backup-id '<recorded ID>' backups/rivune-before-1.6.0.dump
# edit RIVUNE_VERSION=1.6.0 in .env
