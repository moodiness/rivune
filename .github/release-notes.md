...
- Set `RIVUNE_VERSION=1.13.4`, pull, and recreate only Rivune. No database migration or protocol-version change is required from v1.13.3.
...
- `ghcr.io/moodiness/rivune:1.13.4`
...
**Full changelog:** https://github.com/moodiness/rivune/compare/v1.13.3...v1.13.4
