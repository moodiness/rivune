...
- Set `RIVUNE_VERSION=1.13.2`, pull, and recreate only Rivune. Startup applies embedded migrations `000082` through `000094` transactionally before readiness.
...
- `ghcr.io/moodiness/rivune:1.13.2`
...
**Full changelog:** https://github.com/moodiness/rivune/compare/v1.12.4...v1.13.2
