...
- Android playback now offers automatic AndroidX Media3-to-mpv fallback for unsupported media plus explicit Media3 and embedded mpv choices, with the official engine marks in the player picker and no premature external-player launch.
...
- `ghcr.io/moodiness/rivune:1.7.1`
- `ghcr.io/moodiness/rivune:1.7`
- `ghcr.io/moodiness/rivune:1`
- `ghcr.io/moodiness/rivune:latest`
- Platforms: `linux/amd64`, `linux/arm64`

**Full changelog:** https://github.com/moodiness/rivune/compare/v1.7.0...v1.7.1
