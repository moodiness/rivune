...
public sealed class CredentialIsolationTests
{
    ...
    private sealed class RecordingHandler(string apiBaseUrl = "/api/v1") : HttpMessageHandler
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            {
                var discovery = $$"""
                    {"name":"Rivune","serverVersion":"test","protocolVersion":22,"apiBaseUrl":"{{apiBaseUrl}}","setupRequired":false,"setupCompleted":true,"demoAvailable":false,"timezone":"UTC","interfaceLanguage":"en"}
                    """;
